...
export const tutorialCatalog = {
  ...
  shipping: {
    ...
    steps: [routeStep("/dashboard/vendor/shipping", "Shipping setup", "Store-level shipping determines the delivery choices available to eligible physical products."),
      ...
      { title: "Local pickup", body: "Pickup is enabled on eligible products. Use a safe collection location and confirm that pickup orders follow the ready-for-pickup flow rather than shipping statuses." },

...
export const tutorialCatalog = {
  essentials: {
    ...
    steps: [
      ...
      { route: "/dashboard/vendor", selector: '[data-tour="vendor-readiness"]', title: "Open for business checklist", body: "You can set up your store before uploading identity documents. Complete email verification, ID and selfie review, phone, logo, description, bank details and a first listing before requesting approval to go live." },
  ...
  orders: {
    ...
    steps: [
      ...
      { route: "/dashboard/vendor/orders?view=services", selector: '[data-tour="service-order-links"]', title: "Service work shortcuts", body: "Open Service Desk to manage bookings, requests, quotes and subscribers in one place." },
  ...
  serviceDesk: {
    label: "Service Desk", description: "One workspace for appointments, requests, quotes and recurring services.", category: "Customers & fulfilment", duration: "5 min",
    steps: [
      routeStep("/dashboard/vendor/service-desk", "Everything in one Service Desk", "Manage bookings, on-demand requests, quotes and subscriptions from this shared workspace."),
      { route: "/dashboard/vendor/service-desk", selector: '[data-tour="desk-summary"]', title: "Start with attention", body: "Choose Needs attention to find appointments to confirm, enquiries to answer and subscription issues. These counts describe work, not earnings." },
      { route: "/dashboard/vendor/service-desk", selector: '[data-tour="desk-types"]', title: "Choose a type", body: "Keep everything together or narrow to bookings, requests and quotes, or subscriptions." },
      { route: "/dashboard/vendor/service-desk", selector: '[data-tour="desk-filters"]', title: "Find the next task", body: "Search by customer, service or reference. Filter by queue and service, or switch to the appointment calendar. Times use Trinidad and Tobago time." },
      { route: "/dashboard/vendor/service-desk", selector: '[data-tour="desk-record"]', activateSelector: '[data-tour="desk-record"]', title: "Open the complete record", body: "Select a record to open customer information, payment details, notes and available actions in the same workspace. Opening a record does not change it." },
      { selector: '[data-tour="desk-detail"]', title: "Take the right next step", body: "Confirm appointments, respond with a price, save private booking notes, share meeting links or record a delivered subscription session. Review the confirmation before changing a customer’s record." },
      { title: "Payment and completion", body: "Paid online excludes cash payments. Customers confirm delivered services; subscription sessions are deducted only after you record them. Cancellations use the existing refund process." },
    ],
  },
  bookings: {
    label: "Bookings in Service Desk", description: "One workspace for appointments, requests, quotes and recurring services.", category: "Customers & fulfilment", duration: "5 min",
    steps: [
      routeStep("/dashboard/vendor/service-desk", "Everything in one Service Desk", "Manage bookings, on-demand requests, quotes and subscriptions from this shared workspace."),
      { route: "/dashboard/vendor/service-desk", selector: '[data-tour="desk-summary"]', title: "Start with attention", body: "Choose Needs attention to find appointments to confirm, enquiries to answer and subscription issues. These counts describe work, not earnings." },
      { route: "/dashboard/vendor/service-desk", selector: '[data-tour="desk-types"]', title: "Choose a type", body: "Keep everything together or narrow to bookings, requests and quotes, or subscriptions." },
  ...
  subscribers: {
    label: "Subscriptions in Service Desk", description: "One workspace for appointments, requests, quotes and recurring services.", category: "Customers & fulfilment", duration: "5 min",
    steps: [
      routeStep("/dashboard/vendor/service-desk", "Everything in one Service Desk", "Manage bookings, on-demand requests, quotes and subscriptions from this shared workspace."),
      { route: "/dashboard/vendor/service-desk", selector: '[data-tour="desk-summary"]', title: "Start with attention", body: "Choose Needs attention to find appointments to confirm, enquiries to answer and subscription issues. These counts describe work, not earnings." },
      { route: "/dashboard/vendor/service-desk", selector: '[data-tour="desk-types"]', title: "Choose a type", body: "Keep everything together or narrow to bookings, requests and quotes, or subscriptions." },
  ...
  requests: {
    label: "Requests in Service Desk", description: "Review and respond to on-demand work and custom quotes.", category: "Customers & fulfilment", duration: "5 min",
    steps: [
      routeStep("/dashboard/vendor/service-desk", "Everything in one Service Desk", "Manage bookings, on-demand requests, quotes and subscriptions from this shared workspace."),
      { route: "/dashboard/vendor/service-desk", selector: '[data-tour="desk-summary"]', title: "Start with attention", body: "Choose Needs attention to find appointments to confirm, enquiries to answer and subscription issues. These counts describe work, not earnings." },
      { route: "/dashboard/vendor/service-desk", selector: '[data-tour="desk-types"]', title: "Choose a type", body: "Keep everything together or narrow to bookings, requests and quotes, or subscriptions." },

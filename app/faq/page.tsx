  ...
  return (
    ...
    >
      ...
      <FaqGroup kicker="Marketplace" title="Shopping and checkout">
        ...
        <FaqItem question="When is an order confirmed?">Online-paid orders are confirmed after LinkWe receives successful payment confirmation. An abandoned, declined or unconfirmed payment does not create a right to fulfilment. Eligible pay-on-arrival service bookings use the confirmation instructions shown on that booking.</FaqItem>
      ...
      <FaqGroup kicker="Services & events" title="Bookings, requests and tickets">
        ...
        <FaqItem question="Can I pay for a service on arrival?">Eligible non-virtual bookings from active Growth or Pro stores can offer this option. Follow the payment choice shown for that service. Direct payments are collected by the provider and do not pass through WiPay or the LinkWe payout balance.</FaqItem>
      ...
      <FaqGroup kicker="Build on LinkWe" title="Vendors, plans and Rex">
        ...
        <FaqItem question="Can a vendor change plans?">Growth and Pro are managed from Finance → Plan & Rex. Upgrade there; contact support for downgrades. Cancellation stops future periods according to the displayed billing flow and does not automatically refund a current period. The live Pricing page controls current plan prices, limits, and commission.</FaqItem>
      </FaqGroup>

      <FaqGroup kicker="Your account" title="Safety, privacy and support">
        <FaqItem question="How do I stay safe on LinkWe?">Use the payment options shown for your order or service booking, never share passwords or one-time codes, review seller and listing details, keep order records, protect ticket QR codes, and report suspicious activity. Card entry occurs through WiPay—not through Messages or Timeline.</FaqItem>

...
export default function PublicNav({
  ...
  return (
    ...
    <div
      className="fixed bottom-0 left-0 right-0 z-[100] sm:hidden border-t border-zinc-200
        bg-white shadow-lg"
    >
      ...
      px-2 py-1 text-zinc-500 transition-colors hover:text-[#D4450A]"
        ...
        <Link
          href="/services"
          className="flex flex-col items-center gap-0.5 rounded-xl px-2 py-1 text-zinc-500 transition-colors hover:text-[#D4450A]"
        >
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" />
          </svg>

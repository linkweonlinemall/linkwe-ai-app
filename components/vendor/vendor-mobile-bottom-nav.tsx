...
export default function VendorMobileBottomNav() {
  ...
  return (
    <>
      <nav
        className="vendor-premium-bottom-nav fixed bottom-0 left-2 right-2 z-[101] grid grid-cols-5 rounded-t-[22px] border border-b-0 border-black/[0.08] bg-white/95 pb-safe pt-1 shadow-[0_-12px_30px_rgba(28,28,26,0.13)] backdrop-blur-xl md:hidden"

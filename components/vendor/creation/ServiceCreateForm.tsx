  ...
  return (
    <div data-creation-form="true">
      <div data-creation-heading="true" className="mb-6">
        <Link
          href="/dashboard/vendor/creation?type=service"
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div data-creation-section="Service images" data-tour="service-media" className="rounded-2xl border border-zinc-200 bg-white p-5">
        ...
        {/* Publish */}
        <div data-creation-section="Visibility" data-tour="service-publish" className="rounded-2xl border border-zinc-200 bg-white p-5">
        ...
        <div className="flex gap-3">
          <button
            type="button"
            onClick={() => router.push("/dashboard/vendor/creation?type=service")}

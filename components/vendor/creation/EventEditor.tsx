...
import { EditEventForm, type EventFormData } from "@/app/(dashboard)/dashboard/vendor/events/[id]/edit/EditEventForm"
...
export default async function EventEditor({
  ...
  if (!event) redirect("/dashboard/vendor/creation?type=event")

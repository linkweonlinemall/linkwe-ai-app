...
export default function StoreDiscoveryMap({ stores }: { stores: MapStore[] }) {
  ...
  useEffect(() => {
    ...
    mapRef.current?.flyTo({ center: [longitude, latitude], zoom: region === "all" ? 8.3 : 11.2, duration: 1100, essential: true });
    setSelected(null);

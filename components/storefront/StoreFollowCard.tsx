    ...
    <div className="mb-3.5 rounded-xl bg-[#1C1C1A] p-[18px] text-center">
      {following ? (
        <>
          ...
          <p className="text-[13px] font-medium text-white">Following</p>
          <button
            type="button"
            disabled={busy}
            onClick={() => void toggle()}
        ...
        <>
          <p className="text-sm font-medium text-white">Support this store</p>
          <p className="mb-3.5 mt-1 text-[11px] text-white/[0.45]">
            Follow to get updates on new arrivals
          </p>
          <button
            type="button"
            disabled={busy}
